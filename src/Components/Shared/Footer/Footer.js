...
const Footer = () => {
    return (
        ...
        <footer class="bg-orange-100 mt-10 dark:bg-gray-800 p-4">
            <div class="container px-6 py-4 mx-auto">
                        ...
                        <div class="px-6">
                            ...
                            <div class="flex mt-4 -mx-2 " data-aos="fade-right">
                                <a href="#" class="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="Linkden">
                                    <svg class="w-10 h-10 fill-current" viewBox="0 0 512 512">
                ...
                <div>
                    <p class="text-center text-gray-800 dark:text-white">© Jannatul Mithila 2022</p>
                </div>
            </div>
        </footer>
    );
